...
const Navbar = ({
  ...
  return (
    <div>
      <nav className="w-[100%] p-2 md:p-5  relative flex items-center justify-between lg:justify-between xl:justify-around">
        <Link to="/">
          <div className="px-4 flex justify-center gap-2 items-center">
            <h1 className={`font-semibold ${logoColor} text-[25px]`}>
              Vaccine app
            </h1>
          </div>
        </Link>
